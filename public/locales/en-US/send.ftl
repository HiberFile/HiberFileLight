...
sendYourFilesLink = Try HiberFile
errorPageHeader = Something went wrong!
fileTooBig = That file is too big to upload. It should be less than { $size }
linkExpiredAlt = Link expired
notSupportedHeader = Your browser is not supported.
notSupportedLink = Why is my browser not supported?
notSupportedOutdatedDetail = Unfortunately this version of Firefox does not support the web technology that powers HiberFile. You’ll need to update your browser.
updateFirefox = Update Firefox
deletePopupCancel = Cancel
deleteButtonHover = Delete (beware, this will permanently delete the file)
footerText = HiberFile Team.
footerLinkDonate = Donate
footerLinkCli = CLI
footerLinkDmca = DMCA
footerLinkSource = GitHub
passwordTryAgain = Incorrect password. Try again.
javascriptRequired = HiberFile requires JavaScript
whyJavascript = Why does HiberFile require JavaScript?
